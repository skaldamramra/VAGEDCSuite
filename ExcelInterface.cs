    ...
    class ExcelInterface
    {
        ...
        public void ExportToCSV(string mapname, int address, int length, byte[] mapdata, int cols, int rows, bool isSixteenbit, int[] xaxisvalues, int[] yaxisvalues, bool isupsidedown, string xaxisdescr, string yaxisdescr, string zaxisdescr)
        {
            ...
            try
            {
                ...
                try
                {
                    wb.SaveAs(Tools.Instance.m_currentfile + "~" + mapname + ".csv", Microsoft.Office.Interop.Excel.XlFileFormat.xlCSV, null, null, false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange, false, null, null, null, null);
        ...
        public void ExportToXML(string mapname, int address, int length, byte[] mapdata, int cols, int rows, bool isSixteenbit, int[] xaxisvalues, int[] yaxisvalues, bool isupsidedown, string xaxisdescr, string yaxisdescr, string zaxisdescr)
        {
            //en-US
            CultureInfo tci = new CultureInfo("en-US");
            Thread.CurrentThread.CurrentCulture = tci;
            ...
            try
            {
                ...
                try
                {
                    wb.SaveAs(Tools.Instance.m_currentfile + "~" + mapname + ".xml", Microsoft.Office.Interop.Excel.XlFileFormat.xlOpenXMLWorkbook, null, null, false, false, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlNoChange, false, null, null, null, null);
